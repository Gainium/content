...
description: >-
  ...
  conditions using webhooks, indicators, and deal limits.
...
tldr: >-
  ...
  and stop based on webhooks, technical indicators, or after a specified number
  of deals. It removes the need for manual intervention in managing bot
  activity.
---
