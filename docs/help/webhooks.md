...
- Deal Start- [Add funds](https://gainium.io/help/add-funds-to-deals)- Take Profit- Stop Loss- Start bot

![webhooks.png](https://gainium.io/images/content/help/webhooks_8680099d81-baf1c8.png)
...
![webhook config.png](https://gainium.io/images/content/help/webhook_config_9e09b29865-39398f.png)
...
![TV-add-alert.png](https://gainium.io/images/content/help/TV_add_alert_25a34c4c24-a5f174.png)

You will be presented with the following window. Click on “Webhook URL”.

![tv-alert.png](https://gainium.io/images/content/help/tv_alert_33541b208e-5d9fa4.png)
...
- Open deal: will instruct the bot to start a new deal.- Close all deals: will instruct to close all open deals at market price.- Close bot- [Add funds](https://gainium.io/help/add-funds-to-deals)
