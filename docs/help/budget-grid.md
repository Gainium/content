---
id: 10
name: Budget (Grid Bots)
slug: budget-grid
description: Learn how the budget in the grid bot works.
createdAt: '2022-08-09T05:18:51.514Z'
updatedAt: '2026-02-24T07:44:20.566Z'
publishedAt: '2022-08-09T05:18:53.232Z'
locale: en
categories:
  - grid-bots
difficulty: beginner
...
tldr: >-
  The grid bot budget defines the total funds allocated for trading, with a
  minimum calculated from the number of grid levels multiplied by the
  exchange''s minimum order size. You can increase or decrease the budget by
  editing the bot configuration.
---

## Introduction

Welcome to Gainium, where we blend cutting-edge technology with user-friendly features to enhance your cryptocurrency trading experience. One of the standout tools in our arsenal is the grid bot, a powerful ally in navigating the dynamic crypto markets. An essential aspect of leveraging this tool effectively is mastering the art of budget setting. In this article, we'll guide you through the nuances of managing your grid bot's budget, ensuring you're well-equipped for success.
