...
- CI now runs a real `npm test` (mocha) on every PR. This repo had no
  test runner or CI before; `test/placeholder.spec.ts` is a stand-in
  until real coverage lands.

## [1.0.3] - 2026-06-02
### Added
- Self-hosted deployment guide help article (`docs/help/Gainium Self-Hosted — Deployment Guide.md`)
